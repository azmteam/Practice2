...
public class GetCitycodetest {
	...
	static String TestDataTab = "categoryGET";
	...
	public GetCitycodetest(Map<Object, Object> testdatamap) {
	...
	@Test
	public void testCityCode() throws Exception {
		try {
			Log.ReportEvent("PASS", " API Verification Suceessfully");
			categoryMethods.Categories(testdatamap);
	...
	public void setup() throws Exception {
		...
		test = ExtentReportManager.CreateExtentReportTest(extent, className, testdatamap.get("TestDescription").toString(),
				TestScriptID);
		categoryMethods = new categoryMethods(test);
		Log =new Log(test);
